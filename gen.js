...
const out = tools_data.map(t => {
    const tid = t.slug.replace(/-/g, '_');
    
    const htmlControls = t.html_controls.replace(/\\{tid\\}/g, tid);
...
fs.writeFileSync('c:\\\\Users\\\\manav\\\\OneDrive\\\\tool verse\\\\src\\\\tools\\\\image-tools2.js', 'module.exports = ' + JSON.stringify(out, null, 4) + ';', 'utf-8');

console.log("Generated src/tools/image-tools2.js successfully!");
